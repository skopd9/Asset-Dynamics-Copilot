export const translations = {
  en: {
      ...
      items: [
        {
          ...
          desc: "Ask any question about any lease. Get the answer in seconds, not days.",
        },
        {
          title: "Automated Alerts",
          desc: "Break clauses, expirations, rent reviews — nothing slips through.",
        },
        {
          title: "CPI Verification Engine",
          desc: "Every landlord escalation checked against ELSTAT data automatically.",
        },
        {
          title: "SAP + IFRS 16 Sync",
          desc: "Lease changes flow straight into S/4HANA. No manual re-entry.",
        },
        {
    ...
    implementation: {
      title: "Three steps. No disruption.",
      subtitle: "We handle the heavy lifting. Your teams keep running.",
      steps: [
        {
          step: "01",
          title: "Data Onboarding",
          desc: "Every Masoutis and Kritikos lease standardized into one verified dataset.",
        },
        {
          step: "02",
          title: "SAP Configuration",
          desc: "IFRS 16 reporting wired into your existing finance workflows.",
        },
        {
          step: "03",
          title: "Go Live",
          desc: "Role-based access, alerting rules, and KPI dashboards — operational from week one.",
        },
      ],
      outcomes: [
        {
          title: "Governance",
          desc: "One source of truth. Automated deadlines. Audit-ready reporting.",
        },
        {
          title: "Operations",
          desc: "Faster renewals. Fewer missed adjustments. Full visibility across every store format.",
        },
      ],
    },
    proof: {
      title: "Already running in Greece.",
      subtitle: "Built by Recognyte, the technology arm of Resolute Asset Management.",
      stats: [
        { stat: "5,000+", label: "Properties managed for Piraeus Bank" },
    ...
    footer: {
      rights: "Recognyte (A subsidiary of Resolute Asset Management). All rights reserved.",
    },
  },
  el: {
    nav: {
    ...
    platform: {
      title: "Τι αλλάζει από την πρώτη μέρα",
      items: [
        {
          title: "AI Lease Copilot",
          desc: "Ρωτήστε οτιδήποτε για οποιαδήποτε μίσθωση. Απάντηση σε δευτερόλεπτα, όχι ημέρες.",
        },
        {
          title: "Αυτοματοποιημένες Ειδοποιήσεις",
          desc: "Ρήτρες λήξης, λήξεις, αναθεωρήσεις ενοικίων — τίποτα δεν ξεφεύγει.",
        },
        {
          title: "Μηχανή Επαλήθευσης ΔΤΚ",
          desc: "Κάθε αναπροσαρμογή ιδιοκτήτη ελέγχεται αυτόματα βάσει δεδομένων ΕΛΣΤΑΤ.",
        },
        {
          title: "Συγχρονισμός SAP & IFRS 16",
          desc: "Οι αλλαγές μισθώσεων περνούν απευθείας στο S/4HANA. Χωρίς χειροκίνητη εισαγωγή.",
        },
        {
    ...
    implementation: {
      title: "Τρία βήματα. Καμία αναστάτωση.",
      subtitle: "Εμείς αναλαμβάνουμε τη βαριά δουλειά. Οι ομάδες σας συνεχίζουν κανονικά.",
      steps: [
        {
          step: "01",
          title: "Ενσωμάτωση Δεδομένων",
          desc: "Κάθε μίσθωση Μασούτη και Κρητικού τυποποιείται σε ένα επαληθευμένο σύνολο δεδομένων.",
        },
        {
          step: "02",
          title: "Ρύθμιση SAP",
          desc: "Η αναφορά IFRS 16 συνδέεται με τις υφιστάμενες ροές εργασίας σας.",
        },
        {
          step: "03",
          title: "Ενεργοποίηση",
          desc: "Πρόσβαση ανά ρόλο, κανόνες ειδοποιήσεων και πίνακες KPI — λειτουργικό από την πρώτη εβδομάδα.",
        },
      ],
      outcomes: [
        {
          title: "Διακυβέρνηση",
          desc: "Μία πηγή αλήθειας. Αυτοματοποιημένες προθεσμίες. Αναφορές έτοιμες για έλεγχο.",
        },
        {
          title: "Λειτουργίες",
          desc: "Ταχύτερες ανανεώσεις. Λιγότερες χαμένες αναπροσαρμογές. Πλήρης ορατότητα σε κάθε τύπο καταστήματος.",
        },
      ],
    },
    proof: {
      title: "Ήδη σε λειτουργία στην Ελλάδα.",
      subtitle: "Δημιουργήθηκε από τη Recognyte, τον τεχνολογικό βραχίονα της Resolute Asset Management.",
      stats: [
        { stat: "5.000+", label: "Ακίνητα υπό διαχείριση για την Τράπεζα Πειραιώς" },
    ...
    footer: {
      rights: "Recognyte (Θυγατρική της Resolute Asset Management). Με την επιφύλαξη παντός δικαιώματος.",
    },
  },
};
